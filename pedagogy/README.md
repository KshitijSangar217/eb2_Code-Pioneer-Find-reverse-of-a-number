...
:--|:--|:--|:-
1.|<br>Interpret flow  of program execution| <br> On the simulator , comments will be shown to students to understand the flow  |<br> Scanf() is used to take_______ from user?<br> A. $ <br><b> B.%</b><br> C./ <br> D.*| <br>
